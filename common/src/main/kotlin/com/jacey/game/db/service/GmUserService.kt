...
import com.jacey.game.db.table.DbGmUser
...
object GmUserService {
    private val collection get() = Mongo.db.getCollection(DbGmUser.COLLECTION_NAME, DbGmUser::class.java)
    ...
    suspend fun findGmUserByUsername(username: String): DbGmUser? =
    ...
    suspend fun saveAdminGmUserEntity() {
        ...
        collection.insertOne(
            DbGmUser(_id = 1, username = "admin", passwordMD5 = "21232F297A57A5A743894A0E4A801FC3")
        )
    }
}
