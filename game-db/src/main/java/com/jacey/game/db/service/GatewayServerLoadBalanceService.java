...
public interface GatewayServerLoadBalanceService {
     ...
     * @param gatewayId
     */
    void setOneSessionIdToGatewayId(int sessionId, int gatewayId);
     ...
     * @return
     */
    Integer getOneSessionIdToGatewayId(int sessionId);
     ...
     * @param sessionId
     */
    void removeOneSessionIdToGatewayId(int sessionId);
     ...
     */
    void setOneGatewayLoadBalance(int gatewayId, int count);
     ...
     */
    void changeOneGatewayLoadBalance(int gatewayId, int changeCount);
     ...
     * @param gatewayId 网关服务器id
     */
    void removeOneGatewayLoadBalance(int gatewayId);
     ...
     * @return
     */
    Map<Integer, Integer> getAllGatewayLoadBalance();

    /**
     * 清除Gateway网关服务器的所有负载信息
     */
    void cleanGatewayLoadBalance();
     ...
     */
    void setOneGatewayIdToConnectPath(int gatewayId, String connectPath);
     ...
     * @return
     */
    String getOneGatewayIdToConnectPath(int gatewayId);
     ...
     * @param gatewayId 网关服务器id
     */
    void removeOneGatewayIdToConnectPath(int gatewayId);


    /**
     * 清除所有网关服务器id与连接地址的绑定关系
     */
    void cleanGatewayIdToConnectPath();
}
