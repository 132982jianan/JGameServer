...
public interface LogicServerLoadBalanceService {
     ...
     * @param logicServerId
     */
    void setOneSessionIdToLogicServerId(int sessionId, int logicServerId);
     ...
     * @return
     */
    Integer getOneSessionIdToLogicServerId(int sessionId);

    /**
     *
     * @param sessionId
     */
    void removeOneSessionIdToLogicServerId(int sessionId);
     ...
     * @param logicServerId 逻辑服务器id
     */
    void removeOneLogicServerLoadBalance(int logicServerId);
